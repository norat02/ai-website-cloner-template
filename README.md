...
2. **Open your new repository on your computer**
   ...
   Prefer a one-line install instead of using **Use this template**? You can add it directly with `npx`:

   ```bash
   npx skills@latest add norat02/ai-website-cloner-template
   ```
...
| [Replit AI](https://docs.replit.com/replitai/agent)           | Supported                  |
