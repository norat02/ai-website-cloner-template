...
# Amazon Q, GitHub Copilot Chat, Replit AI).
#
# Usage:
...
# Replit AI — replit.md (must live at project root; Replit doesn't
# resolve @file imports itself, so we inline the full content)
write_file "$REPO_ROOT/replit.md" "$RESOLVED_CONTENT"
